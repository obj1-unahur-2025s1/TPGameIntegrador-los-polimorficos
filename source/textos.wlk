...
const teroPiolado =              new TextosInfo(texto ="               Estas en: Tero Violado",             color =color.blanco(), position = game.at(8,15))
const iglesiaTeroPiolado =       new TextosInfo(texto ="      Estas en: Iglesia de Tero Violado",             color =color.blanco(), position = game.at(8,15))
